...
Here is \textbf{Postulate 2} reworked for density matrices:
\begin{quote}
...
Note that this computation is consistent with \textbf{Lemma \ref{lemma state into density}} and {\bf{Postulate 2}} since
\begin{eqnarray}
