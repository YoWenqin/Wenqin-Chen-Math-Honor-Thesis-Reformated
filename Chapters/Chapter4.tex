...
Note that density matrices can be viewed as generalizing state vectors.  Let $\psi$ be a state vector and consider the assignment
$$\psi \xrightarrow{\iota} \ket{\psi}\bra{\psi}.$$
