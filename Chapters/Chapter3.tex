...
\begin{definition}[Measuring in a Basis]\footnote{Measuring in a basis actually belongs to a special subclass of quantum measurement called \textit{projective measurement}. We will define projective measurements rigorously in the \textbf{Appendix \ref{AppendixB}}, but for our purposes it is sufficient just to introduce measuring with respect to an orthonormal basis.} 
