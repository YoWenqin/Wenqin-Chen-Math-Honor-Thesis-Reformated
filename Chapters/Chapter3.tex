...
By the computation in \textbf{Section \ref{section:complex vector space}}, we see that $\{\ket{e_m}\bra{e_m}\}$ is a family of operators as defined in \textbf{Postulate 3}.  The calculation in \textbf{Example \ref{measurement-standard basis}} is exactly this computation, applied to the standard basis in  $\mathbb{C}^2$.

While \textbf{Example \ref{measurement-standard basis}} shows a measurement with respect to the standard basis, here is an additional example of measuring on the Hadamard basis.
