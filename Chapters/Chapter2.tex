...
\begin{definition}
If $V$ is a complex vector space, a {\emph{Hermitian inner product}} $\langle\hspace{.1cm},\hspace{.1cm}\rangle$ is a function from $V \times V$ to $\mathbb{C}$ which satisfies: 
