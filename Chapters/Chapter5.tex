...
We now provide an example of a transcription using a one-time pad.
...
\textcolor{blue}{Say something more about the quantum version of the game. Basically here they use this entanglement "machine" }
