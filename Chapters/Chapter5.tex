...
\textcolor{blue}{We have to define the terms we're using in the definition below.  Also, I would combine the next two definitions into one definition}
...
\end{definition}
This means that in a secret encryption scheme, if Eve sees the ciphertext, she knows nothing more than anyone else who hasn't seen the ciphertext at all. 
